...
public class EmbeddedSQL {
   ...
   public static void Query2(EmbeddedSQL esql){
      // Your code goes here.
      try{
        String query = "SELECT A.sname AS Suppliers_Name, A.Parts_Count AS Parts_Count_3MORE "+
   ...
   public static void Query4(EmbeddedSQL esql){
      // Your code goes here.
      try{
        String query = "SELECT suppliers.sname AS Supplier_Name, MAX(catalog.cost) AS MAX_PRICE "+
           "FROM catalog, suppliers "+
   ...
   public static void Query5(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "SELECT parts.pname FROM Catalog, parts WHERE Catalog.pid=parts.pid Catalog.cost < ";
         System.out.print("\tEnter cost: $");
         String input = in.readLine();
         query += input;
